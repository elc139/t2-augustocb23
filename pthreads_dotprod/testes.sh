...
for i in $(seq 0 9); do {
    echo $i...
    ./pthreads_dotprod 1 1000000 4000
} done
...
for i in $(seq 0 9); do {
    echo $i...
    ./pthreads_dotprod 2 500000 4000
} done
...
for i in $(seq 0 9); do {
    echo $i...
    ./pthreads_dotprod 4 250000 4000
} done
...
for i in $(seq 0 9); do {
    echo $i...
    ./pthreads_dotprod 8 125000 4000
} done
...
for i in $(seq 0 9); do {
    echo $i...
    ./pthreads_dotprod 4 250000 1000
} done
...
for i in $(seq 0 9); do {
    echo $i...
    ./pthreads_dotprod 8 125000 1000
} done
...
for i in $(seq 0 9); do {
    echo $i...
    ./pthreads_dotprod 1 1000000 500
} done
